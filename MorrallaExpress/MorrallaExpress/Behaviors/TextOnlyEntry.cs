...
{
    public class TextOnlyEntry : Behavior<CustomEntry>
    {
        ...
        void OnEntryTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                bool isValid = e.NewTextValue.ToCharArray().All(x => char.IsLetter(x) || char.IsWhiteSpace(x)); //Make sure all characters are numbers
